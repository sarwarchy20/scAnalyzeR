      ...
      tabsetPanel( id = "tabset",
                   ...
                   tabPanel("Pre-processing",
                            ...
                            sidebarPanel(id= "prep_pro" ,width = 4,
                                         ...
                                         actionButton('ok', 'Create dataset'),
                                         tags$hr(),
                                         ...
                                         conditionalPanel('input.fth==1',
                                                          ...
                                                          checkboxInput(inputId="fth_mdatack",
                                                                        p('Plot Meta Data')),
                            ...
                            conditionalPanel(
                              "input.fth_mdatack==1",
                            column(width =8,br(), br(),plotOutput("fth_mdataplot"))
                            )
                            ,
                            conditionalPanel(
                              "input.fth_gene_summary==1",
                            column(width =10,br(), br(),
                                    splitLayout(
                                      style = "border: 1px solid silver;",
                                      #cellWidths = 300,
                                      cellArgs = list(style = "padding: 6px"),
                                      plotOutput("fth_umi_mito"),
                                      plotOutput("fth_umi_gene")
                                    ))
                            )
                   ...
                   tabPanel("Normalization",
                            ...
                            conditionalPanel(
                              "input.hfp_disp==1",
                            column(width =8,br(), br(),plotOutput("hfp_plot"))
                            )
                   ...
                   tabPanel("Dimensionality Reduction", 
                            ...
                            sidebarPanel(id = "dim_slid", width = 4, 
                                         ...
                                         # tags$hr(),
                                         checkboxInput('pc_jac_plot',p('Jack Straw Plot(process takes a long time for large dataset)')),
                                         #tags$hr(),
                            ...
                            conditionalPanel('input.ck_pca==1',
                            ...
                            conditionalPanel('input.pc_print==1',
                            column(width = 6, br(),verbatimTextOutput("pca_list"))
                            ),
                            conditionalPanel('input.pc_jac_plot==1',
                            column(width = 8, br(), plotOutput("pc_jac_show"))
                            ),
                            conditionalPanel('input.pc_elbow==1',
                            column(width = 6, br(), plotOutput("pc_elbow_plot"))
                            ),
                            conditionalPanel('input.pc_hmap_ok==1', 
                   ...
                   tabPanel("Clustering", 
                            ...
                            sidebarPanel(id  = "cls_slid", width = 6,
                                         ...
                                         selectInput('clus_algo','Select Algorithm',choices = c("Louvain Algorithm(LA)", 
                                                                                                "Multilevel LA", "SLM algorithm"),selected = 'Louvain Algorithm(LA)'),
                                         tags$head(
                            ...
                            conditionalPanel('input.clus_tsne==1',
                            ...
                            conditionalPanel('input.clus_barplot==1',
                            ...
                            mainPanel(
                              tabsetPanel(id = "plots_tabset",
                                          ...
                                          tabPanel("Feature Plot",
                                                   column(width = 12, img(src = "line_font1.png")),
                                                   sidebarPanel(id = "fetr_slid" , width = 6,
                                                                tags$style("#fetr_slid{background-color:#FF33B8;}"),
                                                                textAreaInput("fetr_genes","Write Gene List", 
                                                                              placeholder = "Please write gene sybmols: one gene per line.",
                                                                              width = "200px", height = "250px")),
